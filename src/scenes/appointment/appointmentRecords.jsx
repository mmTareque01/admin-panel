...
export default function AppointmentRecords() {
  ...
  const columns = Table_Data(['Student', 'Mentor', 'Date', 'Time', 'Query', 'Student Feedback', 'Mentor Feedback'])
  ...
  return (
    <div>
      <Box m="20px">
      <Header title="APPOINTMENTS" subtitle="Managing Appointment Records" />
      <Box
        m="40px 0 0 0"
        height="75vh"
        sx={{
